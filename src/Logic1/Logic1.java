...
nearTen(19) → true
    ...
    /*
    Given 2 ints, a and b, return their sum. However, "teen" values in the range 13..19 inclusive, are extra lucky. So
...
teaParty(20, 6) → 2
    ...
    public int teaParty(int tea, int candy) {
        ...
        else if (tea >= 2 * candy || candy >= 2 * tea) outcome = 2;
        else outcome = 1;
        return outcome;
    }
...
fizzString("fib") → "FizzBuzz"
    ...
    public String fizzString(String str) {
        /*if (str.charAt(0) == 'f' && str.charAt(str.length() - 1) == 'b') str = "FizzBuzz";
        else if (str.charAt(0) == 'f') str = "Fizz";
        else if (str.charAt(str.length() - 1) == 'b') str = "Buzz";
        return str;*/
    ...
    divisible by both 3 and 5, use "FizzBuzz". Note: the % "mod" operator computes the remainder after division, so 23
    % 10 yields 3. What will the remainder be when one number divides evenly into another? (See also: FizzBuzz Code and
     Introduction to Mod)
...
inOrder(1, 1, 2, true) → true
    ...
    /*
    Given three ints, a b c, return true if they are in strict increasing order, such as 2 5 11, or 5 6 7, but not 6 5
    7 or 5 5 7. However, with the exception that if "equalOk" is true, equality is allowed, such as 5 5 7 or 5 5 5.
...
withoutDoubles(3, 3, false) → 6
    ...
    public int withoutDoubles(int die1, int die2, boolean noDoubles) {
        if (noDoubles && die1 == die2) die1 = (die1 % 6) + 1;
        return die1 + die2;
    }
